...
test("average is float", () => {
  expect(
    analyzeArray([1, 2, 3, 23425, 5345346, 0, -12342, 2, 5, 6, 7, 8, 3, 453]),
  ).toEqual({
    average: 382637.07,
    min: -12342,
    max: 5345346,
...
test("an array which contains non numeric values", () => {
  expect(() => analyzeArray([null, "string", true])).toThrow(
    "wrong type, please input an array of numeric values",
  );
});
