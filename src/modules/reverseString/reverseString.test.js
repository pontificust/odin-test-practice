...
test('the function throws the error on the input that is not a string', () => {
    expect(() => reverseString(null)).toThrow('wrong type, please input a string value');
});

test('the function throws the error on the input that is not a string', () => {
    expect(() => reverseString(255)).toThrow('wrong type, please input a string value');
});

test('the function throws the error on the input that is not a string', () => {
    expect(() => reverseString({})).toThrow('wrong type, please input a string value');
});

test('the function throws an error if no arguments is passed', () => {
    expect(() => reverseString(undefined)).toThrow('wrong type, please input a string value');
});