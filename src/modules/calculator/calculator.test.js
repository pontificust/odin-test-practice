...
test("add() throws a type Error on input that is not numeric", () => {
  expect(() => Calculator.add("string", 2675)).toThrow(
    "wrong type, please input a numeric value",
  );
});

test("add() throws a type Error on input that is not numeric", () => {
  expect(() => Calculator.add(Infinity, 2675)).toThrow(
    "wrong type, please input a numeric value",
  );
});
...
test("multiply() throws a type Error on input that is not numeric", () => {
  expect(() => Calculator.multiply(NaN, 22)).toThrow(
    "wrong type, please input a numeric value",
  );
});
...
test("subtract() throws a type Error on input that is not numeric", () => {
  expect(() => Calculator.subtract(1, "dfa")).toThrow(
    "wrong type, please input a numeric value",
  );
});
