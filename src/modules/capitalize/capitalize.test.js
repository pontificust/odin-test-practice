...
test('throws the error on values that are not strings', () => {
    expect(() => capitalize(324)).toThrow('wrong type, please input a string value');
});

test('throws the error on values that are not strings', () => {
    expect(() => capitalize({})).toThrow('wrong type, please input a string value');
});

test('throws the error on values that are not strings', () => {
    expect(() => capitalize(null)).toThrow('wrong type, please input a string value');
});
